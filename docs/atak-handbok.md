...
Visas som bildspel via [viewer.html](viewer.html?deck=atak-handbok).

## ATAK SPECIFIKA STYRNINGAR
- På grund av ATAKS uppbyggnad finns det begränsningar.
- En av dessa är färgsättning av TEAMS, vi har valt att låta standardfärgerna GUL, GRÖN, LJUSBLÅ och RÖD vara då dessa finns som standard i TAK för MARKERS
- De färger som finns för att synas på olika kartunderlag är nedan och HV förslag är att man väljer enligt nedan schema.
- Att använda funktionen # ger bredd i hanteringen av funktioner tex #Sjukvårdare, #Ordonnans
BAT FÄRG
KOMPANI OMR /TEAMFÄRG
PLUTONS OMR/TEAMFÄRG
GRUPP/TEAMFÄRG
- 1:A	LILA
- 2:A	BLÅ
- 3:E	MÖRKRÖD/MAROON
- 4:E	MÖRK GRÖN
GRP 1-4	SAMMA SOM PLUTONFÄRGEN
- OMR=SVART
- TEAM=BRUN
- 1:A	VIT
- 2:A	ORANGE
...
- 4:E	GRÅBLÅ/TEAL
ÖVR FÄRGMARKERING
RESERV FÄRGMARKERING
- LJUSBLÅ	     - VÄNLIG/FRIENDLY
- LJUSGRÖN	     - NEUTRAL/NEUTRAL
- GUL	     	     - OKÄND/UNKNOWN
...
![Bildobjekt 6](assets/atak-handbok/slide19-19.png)
Navigering
Egen positionering
Snabbmeny
Meny träd
...
Note:
Funktioner, tryck, tryck och håll in, 2 fingrar

Fungerar som en gps, du kan rotera, vinkla, låsa på din position etc

---

## Snabbmeny
![Bildobjekt 3](assets/atak-handbok/slide20-20.png)
![Bildobjekt 42](assets/atak-handbok/slide20-21.png)
...
![Bildobjekt 6](assets/atak-handbok/slide21-22.jpg)
![Bildobjekt 10](assets/atak-handbok/slide21-23.png)
...
Slutsats, programmet är likt andra applikationer och går att enkelt navigera med enkla medel.

---

## Lägg in ditt Callsign (ENLIGT FAL-A)och teamfärg:(”Hamburgerikonen” uppe till höger)
![Bildobjekt 6](assets/atak-handbok/slide23-25.jpg)
- Klicka på  ”Hamburgaren”
- scrolla till Settings
Ange enligt FAL-A
![Bildobjekt 16](assets/atak-handbok/slide23-26.jpg)
Välj: Callsign and Device Preferences
- Välj: My Team
- Välj: Färg enligt färgsättning
![Bildobjekt 9](assets/atak-handbok/slide23-27.jpg)
![Bildobjekt 17](assets/atak-handbok/slide23-28.jpg)
- Välj: Remarks
- Ange en Hashtag (tex #Sjukvård)
- Backa 3ggr till ren kartbild
Välj: Callsign Preferences
![Bildobjekt 18](assets/atak-handbok/slide23-29.jpg)
![Bildobjekt 11](assets/atak-handbok/slide23-30.jpg)
Välj: My Callsign
![Bildobjekt 13](assets/atak-handbok/slide23-31.jpg)
![Bildobjekt 39](assets/atak-handbok/slide23-32.png)
...
## Tools: Maps
![Bildobjekt 8](assets/atak-handbok/slide24-33.jpg)
![Bildobjekt 1](assets/atak-handbok/slide24-34.png)
MAPS där samlas alla tillgängliga kartor, här kan man välja olika kartunderlag
![A3FE3D63-218E-4DBC-9C34-96991C3FA5F3](assets/atak-handbok/slide24-35.jpg)
...
## Tools: Maps
![Bildobjekt 1](assets/atak-handbok/slide25-36.png)
...
![Bildobjekt 4](assets/atak-handbok/slide26-37.jpg)
-  Kompassriktning
-  Egen position.
-  Zoom in/ut.
![Bildobjekt 15](assets/atak-handbok/slide26-38.jpg)
![Bildobjekt 3](assets/atak-handbok/slide26-39.jpg)
Tryck och håll in kompassriktning för att ändra.
Rotation: Vit = AV, Gul = På, Hänglås = Låst
3D: Vit = AV, Gul = På, Hänglås = Låst
![Bildobjekt 11](assets/atak-handbok/slide26-40.jpg)
Ändringar av kartans positionering görs med tvåfingersmanöver.
![Bildobjekt 7](assets/atak-handbok/slide26-41.jpg)
![Bildobjekt 12](assets/atak-handbok/slide26-42.jpg)
- Egen position.
- Vit = Fri rörelse.
- Gul = Fast på egen pos.
För att ändra från Gul=låset till Vit håll in ikonen ca 1 sek
![Bildobjekt 13](assets/atak-handbok/slide26-43.jpg)
...
![Bildobjekt 7](assets/atak-handbok/slide29-45.jpg)
Klartext: ”Vart jag är, koordinater”.
![Bildobjekt 6](assets/atak-handbok/slide29-46.jpg)
- Callsign: Ditt namn
- MGRS koordinat
- Höjd
- Hastighet
...
## Tools: Contacts
![Bildobjekt 8](assets/atak-handbok/slide32-49.jpg)
![34C697DB-2BD4-4B3A-99FF-AC107DFA0973](assets/atak-handbok/slide32-50.jpg)
...
![Bildobjekt 4](assets/atak-handbok/slide32-51.png)
![CD16DDBF-D4C0-4339-AAA7-7BAF2F7D85BA](assets/atak-handbok/slide32-52.jpg)
...
## Tools: point dropper
![Bildobjekt 1](assets/atak-handbok/slide36-54.png)
...
![AFB1B6E5-B7C9-433D-A761-58EE1CFDF083](assets/atak-handbok/slide36-55.jpg)
![Bildobjekt 3](assets/atak-handbok/slide36-56.jpg)
...
![7CDF78D4-50B3-49D2-8E2A-975E6EE7665D](assets/atak-handbok/slide38-59.jpg)
...
## Radial meny
RADIAL MENY för egen Pos
- OBS!
- När man har aktiverat en funktion blir den markerad
![7CDF78D4-50B3-49D2-8E2A-975E6EE7665D](assets/atak-handbok/slide39-60.jpg)
6
5
7
1. Markör Info	6. R&B Line
2. Kompass 	7. Threat Rings
3. Polär markör	8. Lås Pos
4. Fin justering	9. Spårbildning
5. GPS AV/PÅ
4
8
3
...
10
1
RADIAL MENY för markör
![58DF5FFD-5576-4F61-A304-415B4EF45192](assets/atak-handbok/slide39-61.jpg)
5
6
1. Radera                6. Skapare
2. Polär markör	  7. Threat Rings
3. Fin justering 	  8. Spårbildning
4. R&B Line            9. Markör Info
5. Lås POS
4
7
3
...
9
1
Kommentar: När funktioner inom har en ”Gul ytterkant” har de ytterligare funktioner. Håll inne för att se alternativen.
...
## Tools: point dropper
![Bildobjekt 1](assets/atak-handbok/slide40-62.png)
![Bildobjekt 15](assets/atak-handbok/slide40-63.jpg)
- Radial menyn öppnas klicka på
- för att redigera information
![AFB1B6E5-B7C9-433D-A761-58EE1CFDF083](assets/atak-handbok/slide40-64.jpg)
Välj PointDropper
![Bildobjekt 7](assets/atak-handbok/slide40-65.png)
Markerad blir gulmarkerad, Klicka i kartan för att lägga ut den
![Bildobjekt 17](assets/atak-handbok/slide40-66.jpg)
Namnge Ikonen genom att klicka brevid ikonen
![Bildobjekt 8](assets/atak-handbok/slide40-67.jpg)
![Bildobjekt 19](assets/atak-handbok/slide40-68.jpg)
![Bildobjekt 10](assets/atak-handbok/slide40-69.jpg)
...
![Bildobjekt 12](assets/atak-handbok/slide40-70.jpg)
![Bildobjekt 4](assets/atak-handbok/slide40-71.jpg)
Du kan nu klicka på ikonen du lagt ut

---

## Tools: Drawing tools
![F35BCC30-A237-4C1F-933A-6C68049BE48C](assets/atak-handbok/slide42-74.jpg)
DRAWING TOOLS låter användaren markera ut olika geometriska former i ATAK.
![0A34B33C-A4D5-4B04-8C5E-56D43984CA92](assets/atak-handbok/slide42-75.jpg)
Kan användas för tex grupperingsområden, vägar, stridsställningar, mineringsområden mm

---

## Tools: LASSO
![Bildobjekt 13](assets/atak-handbok/slide44-77.jpg)
![Bildobjekt 12](assets/atak-handbok/slide44-78.png)
...
![Bildobjekt 14](assets/atak-handbok/slide44-79.jpg)
![Bildobjekt 15](assets/atak-handbok/slide44-80.jpg)
![Bildobjekt 16](assets/atak-handbok/slide44-81.jpg)

---

## Tools: Data packages
DATA PACKAGES nyttjas för att komprimera data, och skicka till det utvald mottagare.
![Bildobjekt 15](assets/atak-handbok/slide46-84.jpg)
...
![57EDA6B0-6978-45E1-80ED-751F8296E4ED](assets/atak-handbok/slide46-85.jpg)
![57EDA6B0-6978-45E1-80ED-751F8296E4ED](assets/atak-handbok/slide46-86.jpg)
Exempel 1
Exempel 1
Exempel 2
Exempel 2
...
## Tools: Data packages
![Bildobjekt 11](assets/atak-handbok/slide47-87.jpg)
![Bildobjekt 12](assets/atak-handbok/slide47-88.jpg)
![57EDA6B0-6978-45E1-80ED-751F8296E4ED](assets/atak-handbok/slide47-89.jpg)
2
3
1
4
5
Plus-ikonen är för att skapa ett nytt DATA PACKAGE.
Download-ikonen laddar ner tidigare DATA PACKAGE från TAK-SERVER.
Transfer Log-ikonen visar tidigare skickade och mottagna DATA PACKAGE.
Multi Select Action-ikonen tar användaren till ”OVERLAY MANAGER”, välj mellan att extrahera alt. radera flertalet DATA PACKAGE.
Sök-ikonen låter användaren hitta efterfrågat DATA PACKAGE.

---

## Tools: Digital pointer
![Bildobjekt 7](assets/atak-handbok/slide48-90.png)
![Bildobjekt 5](assets/atak-handbok/slide48-91.jpg)
Med Digital pointer kan man snabbt påkalla andras uppmärksamhet till ett speciellt objekt (man ser inte själv linjen)
![Bildobjekt 6](assets/atak-handbok/slide48-92.jpg)
...
![Bildobjekt 5](assets/atak-handbok/slide49-93.jpg)
...
![Bildobjekt 6](assets/atak-handbok/slide49-94.jpg)
...
![Bildobjekt 7](assets/atak-handbok/slide49-95.jpg)
...
![Bildobjekt 2](assets/atak-handbok/slide51-99.jpg)
![Bildobjekt 6](assets/atak-handbok/slide51-100.jpg)
![Bildobjekt 1](assets/atak-handbok/slide51-101.jpg)
![Bildobjekt 3](assets/atak-handbok/slide51-102.jpg)
...
![Bildobjekt 10](assets/atak-handbok/slide53-107.png)
![Bildobjekt 9](assets/atak-handbok/slide53-108.png)
MNEMONICS
...
![Bildobjekt 1](assets/atak-handbok/slide56-109.png)
HELA BATALJONEN
...
![Bildobjekt 1](assets/atak-handbok/slide59-110.jpg)
...
![Bildobjekt 15](assets/atak-handbok/slide63-114.jpg)
![Bildobjekt 17](assets/atak-handbok/slide63-115.jpg)
![57EDA6B0-6978-45E1-80ED-751F8296E4ED](assets/atak-handbok/slide63-116.jpg)
![CDF081C6-870C-4F14-8A5C-B835EF5D012D](assets/atak-handbok/slide63-117.jpg)
...
Anropssignaler (Callsign) Skilj strikt på personliga enheter (individuell anropssignal, t.ex. RU1) och funktionsenheter (stabsdator/nod, t.ex. RU).
![bild 13](assets/atak-handbok/hv-slide06-13.png)
Teamfärger Bat=Svart, 1.Komp=Vit, 2.Komp=Orange. Pluton 1-4 ställs in internt. Grupp/Soldat följer plutonens färgkodning.
![bild 14](assets/atak-handbok/hv-slide06-14.png)
Nivåmarkering (Filtreringstagg) Använd #Bat, #Komp, #Plut, #Grp i fältet "Remarks" för att högre staber snabbt ska kunna filtrera fram rätt beslutsnivå.
![bild 15](assets/atak-handbok/hv-slide06-15.png)
Kritiska Enhetsinställningar MGRS, MSL (Meters), km/h, Numeric Heading, Mils, Grid North. Avvikelser skapar kritiska fel vid eldledning!
![bild 16](assets/atak-handbok/hv-slide06-16.png)
